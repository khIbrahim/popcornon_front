...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-4 py-12 overflow-hidden bg-black">
            <ShaderOrbs />
            <AnimatedBackground />
                    ...
                    <div className="flex-1">
                        <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Button
                                ...
                                className="w-full h-14 text-base bg-linear-to-r from-primary to-accent hover:to-primary hover:opacity-90 transition-all text-white font-bold rounded-xl shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed mt-2 cursor-pointer"
                            >
                                {isLoading ? (
